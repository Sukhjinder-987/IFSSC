...
def machine_learning_modeling():
    ...
    if st.button("Predict"):
        ...
        model = joblib.load('lstm_model.h5')

        # Prepare input data for prediction
        input_data = [[Special_Event, Day_of_week, Status, Family_size, Day, Month, Year]]
        ...
        st.success(f"Predicted Number of Food Hampers: {prediction[0]}")
